...
{
    public class FilterProductByName : BaseFilter
    {
        public FilterProductByName(IFilterDecorator nextDecorator, ProductDto filter) : base(nextDecorator, filter)
        {
        }
        ...
        public override IQueryable<Product> Filter(IQueryable<Product> query)
        {
            ...
            return filteredQuery.Where(x => x.Name == FilterDto.Name);
        }
    }
}
